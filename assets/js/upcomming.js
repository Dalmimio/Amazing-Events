...
function combinacionDeFiltros() {
  arrayEventFilter = [];
   //por defecto, que muestre todas las cartas posteriores a la fecha actual
...
function mostrarCartasFiltradas(arrayCart) {
  ...
  if (arrayCart.length > 0) {
    ...
    contenidoCartaUp.innerHTML = ponerCarta;

    });
  } else {
    contenidoCartaUp.innerHTML = `<div class="container__error"><img src="../img/404 Error with a cute animal-amico.svg" alt="img_error"> <br>
